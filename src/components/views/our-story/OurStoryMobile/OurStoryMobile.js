            ...
            <div className={classes["story-card-mobile-container"]}>
                ...
                <div className={classes["card-image-container"]}>
                    ...
                    <div className={classes["card-animation"]}>
                        ...
                        <img src={require(`../../../../helpers/img/${inlineImage}`)} alt="" />
                        </div>
                        <div className={classes["card-animation-text"]}>
                            <div className={classes["animation-text-1"]}>Stranger Things</div>
                            <div className={classes["animation-text-2"]}>{downloadText}</div>
                        </div>
                    </div>
                    </div>
                </div>
